    ...
    $(document).ready(function () {
        ...
        $(document).on('click', '.add_new_block_subscribe', function () {
            ...
            $('.all_block_subscribes').prepend(' <div class="blockcont_one" data-block_id="' + sub_id + '" id="blocksub' + sub_id + '">\n' +
                ...
                '                               <a href="https://ays-pro.com/wordpress/secure-copy-content-protection" target="_blank" class="text-danger ml-2" title="PRO feature"> \n' +
                '                                   PRO version!!!\n' +
                '                               </a>\n' +
                '                           </p>\n' +
                '                       </div>\n' +
        ...
        function openSccpSubMediaUploader(e, element) {
            ...
            let aysUploader = wp.media({
                ...
                if(element.hasClass('add-sccp-sub-icon-image')){
                    ...
                    element.text('Edit Icon');
                    element.parent().parent().find('.ays-sccp-sub-image-container').fadeIn();
                    element.parent().parent().find('img#ays-sccp-sub-img').attr('src', attachment.url);
                    $('input#ays_sccp_sub_icon_image').val(attachment.url);
                }*/
            }).open();
