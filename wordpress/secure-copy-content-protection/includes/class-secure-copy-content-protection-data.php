...
class Ays_Sccp_Data {
    ...
    */
    ...
    public static function ays_sccp_sale_baner(){     
        ...
        // $ays_sccp_sale_two_months = get_option('ays_sccp_sale_dismiss_for_two_month_spring');
        ...
        if(intval($days_diff) > 0 ){
            // update_option('ays_sccp_sale_notification_spring', 0); 
            // update_option('ays_sccp_sale_dismiss_for_two_month_spring', 0);
            update_option('ays_sccp_sale_btn', 0);
            update_option('ays_sccp_sale_btn_for_two_months', 0);
        }

        // $ays_sccp_ishmar = intval(get_option('ays_sccp_sale_notification_spring'));
        // $ays_sccp_ishmar += intval(get_option('ays_sccp_sale_dismiss_for_two_month_spring'));
        ...
        if($ays_sccp_ishmar == 0 ){
            if (isset($_GET['page']) && strpos($_GET['page'], SCCP_NAME) !== false) {
                // self::ays_sccp_spring_bundle_message($ays_sccp_ishmar);
                // self::ays_sccp_helloween_message($ays_sccp_ishmar);
                // self::ays_sccp_black_friday_message($ays_sccp_ishmar);                
                // self::ays_sccp_christmas_message($ays_sccp_ishmar);
                // self::ays_sccp_chart_banner($ays_sccp_ishmar);
                ...
                $content[] = '<div id="ays-sccp-dicount-month-helloween" class="ays_sccp_dicount_month_helloween">';
                    $content[] = '<div class="ays-sccp-dicount-wrap-box-helloween-limited">';
                        ...
                        $content[] = '<p>';
                            ...
                            <span class='ays-sccp-dicount-wrap-color-helloween' style='color:#b2ff00;'>50%</span> 
                            <span>
                                SALE on
                            </span> 
                            <br>
                            <span style='' class='ays-sccp-helloween-bundle'>
                                <a href='https://ays-pro.com/halloween-bundle?src=41' target='_blank' class='ays-sccp-dicount-wrap-color-helloween ays-sccp-dicount-wrap-text-decoration-helloween' style='display:block; color:#b2ff00;margin-right:6px;'>
                                    Helloween Bundle
                                </a>
                    ...
                    $content[] = '<div class="ays-sccp-helloween-bundle-buy-now-timer">';
                        ...
                        $content[] = '<div class="ays-sccp-dicount-wrap-box ays-buy-now-button-box-helloween">';
                            $content[] = '<a href="https://ays-pro.com/halloween-bundle?src=43" class="button button-primary ays-buy-now-button-helloween" id="ays-button-top-buy-now-helloween" target="_blank" style="" >' . __( 'Buy Now !', SCCP_NAME ) . '</a>';
                        $content[] = '</div>';
                    $content[] = '</div>';
                ...
                $content[] = '<div id="ays-sccp-dicount-black-friday-month" class="ays_sccp_dicount_month">';
                    $content[] = '<div class="ays-sccp-dicount-black-friday-box">';
                        $content[] = '<div class="ays-sccp-dicount-black-friday-wrap-box ays-sccp-dicount-black-friday-wrap-box-80" style="width: 70%;">';
                            $content[] = '<div class="ays-sccp-dicount-black-friday-title-row">' . __( 'Limited Time', SCCP_NAME ) .' '. '<a href="https://ays-pro.com/wordpress/secure-copy-content-protection" class="ays-sccp-dicount-black-friday-button-sale" target="_blank">' . __( 'Sale', SCCP_NAME ) . '</a>' . '</div>';
                            $content[] = '<div class="ays-sccp-dicount-black-friday-title-row">' . __( 'Secure Copy Content Protection plugin', SCCP_NAME ) . '</div>';
                        $content[] = '</div>';
                        ...
                        $content[] = '<div class="ays-sccp-dicount-black-friday-wrap-box" style="width: 25%;">';
                            $content[] = '<a href="https://ays-pro.com/wordpress/secure-copy-content-protection" class="ays-sccp-dicount-black-friday-button-buy-now" target="_blank">' . __( 'Get Your Deal', SCCP_NAME ) . '</a>';
                        $content[] = '</div>';
                    $content[] = '</div>';
                $content[] = '</div>';
                ...
                $content[] = '<div style="position: absolute;right: 0;bottom: 1px;"  class="ays-sccp-dismiss-buttons-container-for-form-black-friday">';
                    $content[] = '<form action="" method="POST">';
                        $content[] = '<div id="ays-sccp-dismiss-buttons-content-black-friday">';
                            $content[] = '<button class="btn btn-link ays-button-black-friday" name="ays_sccp_sale_btn" style="">' . __( 'Dismiss ad', SCCP_NAME ) . '</button>';
                        $content[] = '</div>';
                    $content[] = '</form>';
                $content[] = '</div>'; 
            $content[] = '</div>';
