 ...
 */
define('SCCP_NAME_VERSION', '3.6.6');
                ...
                <div id="navigation-container">                   
                    <div class="ays-logo-container-upgrade">
                        ...
                        <div class="ays-upgrade-container">
                            <a href="https://ays-pro.com/wordpress/secure-copy-content-protection?utm_source=sccp-free-dashboard&utm_medium=sccp-top-banner&utm_campaign=sccp-upgrade-button" target="_blank">
                    ...
                    <ul id="menu">
                        <!-- <li class="modile-ddmenu-xss"><a class="ays-btn" href="https://ays-pro.com/wordpress/secure-copy-content-protection" target="_blank"><i class="ays_fa ays_fa_diamond ays-fa-margin-right"></i>PRO</a></li> -->
